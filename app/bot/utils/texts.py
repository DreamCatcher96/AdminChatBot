        ...
        return {
            "en": {
                ...
                "user_started_bot": (
                    ...
                    "<i>⚠️ മൂവിയുടെ ഡൗൺലോഡ് ലിങ്ക് കിട്ടൻ @FileSearch2Bot 👈 ഇതിൽ പോയി നിങ്ങൾക്ക് ആവശ്യമുള്ള മൂവിയുടെ പേര്  മെസ്സേജ് അയക്കുക..!!\n\n 📌NOTE : നിങ്ങൾ അയക്കുന്ന മൂവിയുടെ പേരിൻ്റെ സ്പെല്ലിംങ്ങ് Googlil ഉള്ളത് പോലെ ആണോ എന്ന് കൂടെ ഉറപ്പ് വരുത്തുക..!!</i>"
                ),
