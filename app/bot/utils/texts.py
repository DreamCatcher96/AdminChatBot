        ...
        return {
            "en": {
                ...
                "user_started_bot": (
                    ...
                    "• /silent\n"
                    "• /information\n\n"
                    "<code>𝐁𝐨𝐭 𝐋𝐢𝐧𝐤  ➠ https://telegram.me/FileSearch0Bot\n\n𝐆𝐫𝐨𝐮𝐩 𝟏 𝐋𝐢𝐧𝐤 ➠ https://t.me/+eNoYW8ufodY1ZTA1\n\n𝐎𝐓𝐓 𝐔𝐩𝐝𝐚𝐭𝐞 ➠ https://t.me/+k6tTHF7Z5CY0OGJk</code>\n\n"
                    "<code>⚠️ മൂവി കിട്ടാൻ @FileSearch0Bot 👈 ഇതിൽ പോയി നിങ്ങൾക്ക് ആവശ്യമുള്ള മൂവിയുടെ പേര് മെസ്സേജ് അയക്കുക..!!\n\n 📌NOTE : നിങ്ങൾ അയക്കുന്ന മൂവിയുടെ പേരിൻ്റെ സ്പെല്ലിംങ്ങ് Googlil ഉള്ളത് പോലെ ആണോ എന്ന് കൂടെ ഉറപ്പ് വരുത്തുക..!!</code>\n\n"
                    "<code>𝗣𝗹𝗲𝗮𝘀𝗲 𝗚𝗼 𝘁𝗼 👉 @FileSearch0Bot 𝗮𝗻𝗱 𝗦𝗲𝗻𝗱 𝗬𝗼𝘂𝗿 𝗠𝗼𝘃𝗶𝗲 𝗡𝗮𝗺𝗲 𝗪𝗶𝘁𝗵 𝗖𝗼𝗿𝗿𝗲𝗰𝘁 𝗚𝗼𝗼𝗴𝗹𝗲 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴..!!\n\n@FileSearch0bot\n\nNew Bot</code>"
                ),
